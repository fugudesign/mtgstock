            ...
            <Card>
              ...
              <CardContent>
                <p className="text-slate-600">
                  Recherchez parmi plus de 30 000 cartes Magic avec des filtres avancés 
                  par nom, coût, couleur, rareté et plus encore.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-slate-600">
                  ...
                  Suivez vos cartes par état, quantité et notes personnelles.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-slate-600">
                  ...
                  Mainboard, sideboard et notes stratégiques incluses.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          {loading ? (
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={i} className="aspect-[5/7] bg-slate-200 rounded-lg animate-pulse" />
              ))}
            </div>
          ) : (
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
      ...
      <section className="py-20 px-4 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Rejoignez MTG Stock dès aujourd&apos;hui et donnez une nouvelle dimension 
            à votre passion pour Magic: The Gathering.
          </p>
